const translations = {
  vi: {
    ...
    nav_faq: "FAQ",
    search_placeholder: "Tìm: GEM_ID_LEVEL, max-level, satthuong_1",
    ...
    step_3_copy: "Thêm stat vào từng gem stone với giá trị như satthuong_1.",
    ...
    table_upgrade_2: "Nâng slot cũ thành satthuong_2.",
    table_upgrade_3: "Nâng slot cũ thành satthuong_3.",
    ...
    mi_editor_copy: "Lặp lại cho satthuong_2, satthuong_3 và các cấp còn lại.",
  ...
  en: {
    ...
    nav_mmoitems: "MMOItems",
    nav_faq: "FAQ",
    search_placeholder: "Search: GEM_ID_LEVEL, max-level, satthuong_1",
    ...
    step_3_copy: "Add the stat to each gem stone with a value such as satthuong_1.",
    ...
    table_upgrade_2: "Upgrade the old socket to satthuong_2.",
    table_upgrade_3: "Upgrade the old socket to satthuong_3.",
    ...
    mi_editor_copy: "Repeat for satthuong_2, satthuong_3, and every remaining level.",
